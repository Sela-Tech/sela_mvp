...
//        populateAutoComplete();
        ...
        TextView regRedirect = (TextView) findViewById(R.id.redirect_register);
        regRedirect.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
...
//            return false;
            ...
            try {
                // Connect
                connection = (HttpURLConnection) ((new URL(AuthUtil.LoginURI).openConnection()));
                ...
                loginData.put(AuthUtil.UserNameQueryField, mUsername);
                loginData.put(AuthUtil.PasswordQueryField, mPassword);
                ...
                loginResult = new JSONObject(sb.toString());

                // Check
                if (loginResult.getBoolean(AuthUtil.SuccessStr)) {
                    return true;
                }
                errorMessage = loginResult.getString(AuthUtil.MessageStr);
                return false;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mUsernameView.setError(errorMessage);
                AuthUtil.clearTextFields(mUsernameView, mPasswordView);
