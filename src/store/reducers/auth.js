...
import { storeManager } from "../../helpers/utils";

const area = storeManager.retrieve("areasOfInterest");
const initstate = {
  action: {
    type: "",
    message: ""
  ...
  user_interests: Boolean(area) ? area : []
...
export default (state = initstate, payload) => {
  switch (payload.type) {
    ...
    case authActions.SET_INTERESTS:
    return {
      ...state,
      user_interests: payload.areasOfInterest
    }
    ...
    case authActions.TOKEN_VERIFICATION_S:
      return {
        ...
        credentials: payload.data,
        user_interests: Boolean(area) ? area  :payload.data.areasOfInterest
      };
    ...
    case authActions.SIGNIN_S:
      return {
        ...
        isAuthenticated: true,
        credentials: payload.data,
        user_interests: payload.data.areasOfInterest || []
      };
